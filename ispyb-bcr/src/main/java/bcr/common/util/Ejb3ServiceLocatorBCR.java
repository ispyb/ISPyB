 ...
 */
public class Ejb3ServiceLocatorBCR {

	/* CONSTANTS */
	
	private static final String APP_NAME = "bcr";
	...
	// singleton instance
	private static Ejb3ServiceLocatorBCR serviceLocator;
	 ...
	 */
	public static Ejb3ServiceLocatorBCR getInstance() {
		if (serviceLocator == null) {
			serviceLocator = new Ejb3ServiceLocatorBCR();
		}
	...
	public Object getRemoteService(Class serviceClass) throws NamingException {
		...
		//Object realized = PortableRemoteObject.narrow(ref, serviceClass);
	        ...
	        // let's do the lookup
	        String serviceJndiName = "ejb:"+ APP_NAME + "/" + moduleName + "/" + beanName + "!" + viewClassName;
