...
<TABLE class="tableForm1" id="table0" cellSpacing=10px cellPadding=0>
	...
	<TR>
		...
		<TD align="left"><input class=inputType0 value="" type="text" name="j_username" onfocus="this.hasFocus=true" onblur="this.hasFocus=false" onKeyPress="return submitLogin(this,event)"></TD>
	</TR>
	<TR>
