...
/**
 * This class represents a beamline at ALBA-CELLS.
...
public enum ALBABeamlineEnum {
	...
	public static ALBABeamlineEnum retrieveBeamlineWithName(String aName){
		for(ALBABeamlineEnum b: ALBABeamlineEnum.values()){
	...
	public static String retrieveDirectoryNameWithName(String aName){
		ALBABeamlineEnum beamline = retrieveBeamlineWithName(aName);
		if(beamline != null){
	...
	public static String[] getBeamlineNames(){
		String[] list = new String[ALBABeamlineEnum.values().length];
		int i=0;
		for(ALBABeamlineEnum b: ALBABeamlineEnum.values()){
