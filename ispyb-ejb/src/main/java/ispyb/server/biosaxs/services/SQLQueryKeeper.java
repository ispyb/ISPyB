...
public class SQLQueryKeeper {
	...
	public static String getDataCollection() {
		return "select Crystal.*, Protein.*, Image.*, BLSample.* "
				+ "from Proposal "
	...
	public static String getSessionByCodeAndNumber() {
		return "select * from BLSession, Proposal where Proposal.proposalId = BLSession.proposalId and Proposal.proposalCode= :proposalCode  and Proposal.proposalNumber= :proposalNumber";
	}

	public static String getDataCollectionFromShippingId() {
		return "select * from Shipping left join Dewar on Dewar.shippingId = Shipping.shippingId \r\n"
	...
	public static String getAllDataCollectionFromShippingId() {
		return "select * from Shipping left join Dewar on Dewar.shippingId = Shipping.shippingId \r\n"
				+ " left join Container on Container.dewarId = Dewar.dewarId \r\n"
				+ " left join BLSample on BLSample.containerId = Container.containerId \r\n"
				+ " left join DataCollectionGroup on DataCollectionGroup.blSampleId = BLSample.blSampleId\r\n"
