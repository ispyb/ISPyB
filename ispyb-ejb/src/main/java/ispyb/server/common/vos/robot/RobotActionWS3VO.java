...
public class RobotActionWS3VO extends RobotAction3VO {
	...
	public RobotActionWS3VO() {
		super();
	}

	public RobotActionWS3VO(RobotAction3VO vo) {
		super(vo);
	}

	public RobotActionWS3VO(Integer sessionId, Integer blSampleId) {
		super();
