...
/**
 * <p>
 * The data access object for DewarTransportHistory3 objects (rows of table DewarTransportHistory).
 * </p>
 * 
 * @see {@link DewarTransportHistory3DAO}
 */
@Stateless
public class DewarTransportHistory3DAOBean implements DewarTransportHistory3DAO {
	 ...
	 * </p>
	 */
	public void create(DewarTransportHistory3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public DewarTransportHistory3VO update(DewarTransportHistory3VO vo) throws Exception {
	 ...
	 */
	public void delete(DewarTransportHistory3VO vo) {
	...
	/**
	 * <p>
	 * Returns the DewarTransportHistory3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public DewarTransportHistory3VO findByPk(Integer pk, boolean fetchRelation1, boolean fetchRelation2) {
		try{
			return (DewarTransportHistory3VO) entityManager.createQuery(FIND_BY_PK(fetchRelation1, fetchRelation2))
	...
	/**
	 * <p>
	 * Returns the DewarTransportHistory3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<DewarTransportHistory3VO> findAll(boolean fetchRelation1, boolean fetchRelation2) {
	...
	@SuppressWarnings("unchecked")
	@Override
	public List<DewarTransportHistory3VO> findFiltered(Integer dewarId) {
