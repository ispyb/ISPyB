...
/**
 * <p>
 * 	The data access object for DewarLocationList3 objects (rows of table
 *  DewarLocationList).
 * </p>
 */
@Local
public interface DewarLocationList3DAO {
	 ...
	 * </p>
	 */
	public void create(DewarLocationList3VO vo) throws Exception;
	 ...
	 */
	public DewarLocationList3VO update(DewarLocationList3VO vo) throws Exception;
	 ...
	 */
	public void delete(DewarLocationList3VO vo);

	/* Find methods --------------------------------------------------------- */

	/**
	 * <p>
	 * 	Returns the DewarLocationList3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public DewarLocationList3VO findByPk(Integer pk, boolean fetchRelation1,
			boolean fetchRelation2);

	/**
	 * <p>
	 * 	Returns the DewarLocationList3VO instances.
	 * </p>
	 * <p>
	 *  <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u>
	 *  if the value object has to be used out the EJB container.
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<DewarLocationList3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
