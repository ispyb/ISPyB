...
package ispyb.server.common.daos.admin;
...
/**
 * <p>
 * The data access object for AdminActivity3 objects (rows of table AdminActivity).
 * </p>
 * 
 * @see {@link AdminActivity3DAO}
 */
@Stateless
public class AdminActivity3DAOBean implements AdminActivity3DAO {

	private final static Logger LOG = Logger.getLogger(AdminActivity3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(AdminActivity3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public AdminActivity3VO update(AdminActivity3VO vo) throws Exception {
	 ...
	 */
	public void delete(AdminActivity3VO vo) {
	...
	/**
	 * <p>
	 * Returns the AdminActivity3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public AdminActivity3VO findByPk(Integer pk, boolean fetchRelation1, boolean fetchRelation2) {
		try {
	...
	/**
	 * <p>
	 * Returns the AdminActivity3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<AdminActivity3VO> findAll() {
		return entityManager.createQuery(FIND_ALL()).getResultList();
	}

	@SuppressWarnings("unchecked")
	public List<AdminActivity3VO> findFiltered(String action, String username) {
