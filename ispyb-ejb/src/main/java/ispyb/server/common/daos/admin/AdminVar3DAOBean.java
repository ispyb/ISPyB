...
/**
 * <p>
 * The data access object for AdminVar3 objects (rows of table Admin).
 * </p>
 * 
 * @see {@link AdminVar3DAO}
 */
@Stateless
public class AdminVar3DAOBean implements AdminVar3DAO {

	private final static Logger LOG = Logger.getLogger(AdminVar3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(AdminVar3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public AdminVar3VO update(AdminVar3VO vo) throws Exception {
	 ...
	 */
	public void delete(AdminVar3VO vo) {
	...
	/**
	 * <p>
	 * Returns the AdminVar3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public AdminVar3VO findByPk(Integer pk) {
		try {
	...
	/**
	 * <p>
	 * Returns the AdminVar3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<AdminVar3VO> findAll() {
		return entityManager.createQuery(FIND_ALL()).getResultList();
	}

	@SuppressWarnings("unchecked")
	public List<AdminVar3VO> findFiltered(String name, String value) {
