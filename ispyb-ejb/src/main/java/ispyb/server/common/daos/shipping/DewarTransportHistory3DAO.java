...
/**
 * <p>
 * 	The data access object for DewarTransportHistory3 objects (rows of table
 *  DewarTransportHistory).
 * </p>
 */
@Local
public interface DewarTransportHistory3DAO {
	 ...
	 */
	public DewarTransportHistory3VO findByPk(Integer pk, boolean fetchRelation1,
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<DewarTransportHistory3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
