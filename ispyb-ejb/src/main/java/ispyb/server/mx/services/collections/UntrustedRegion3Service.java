...
@Remote
public interface UntrustedRegion3Service {
	...
	/**
	 * Finds a UntrustedRegion3 entity by its primary key and set linked value objects if necessary.
	...
	/**
	 * Find all UntrustedRegion3 and set linked value objects if necessary.
	 * @param withLink1
	 * @param withLink2
	 */
	public List<UntrustedRegion3VO> findAll() throws Exception;
