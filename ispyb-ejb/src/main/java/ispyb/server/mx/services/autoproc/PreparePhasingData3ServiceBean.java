 ...
 */
@Stateless
public class PreparePhasingData3ServiceBean implements PreparePhasingData3Service, PreparePhasingData3ServiceLocal {

	private final static Logger LOG = LogManager.getLogger(PreparePhasingData3ServiceBean.class);

	// Generic HQL request to find instances of PreparePhasingData3 by pk
	// TODO choose between left/inner join
	private static final String FIND_BY_PK() {
		return "from PreparePhasingData3VO vo " + "where vo.preparePhasingDataId = :preparePhasingDataId";
	}
	...
	public PreparePhasingData3VO findByPk(final Integer pk) throws Exception {
		...
		// TODO Edit this business code
		try {
			return (PreparePhasingData3VO) entityManager.createQuery(FIND_BY_PK())
	...
	public List<PreparePhasingData3VO> findAll() throws Exception {
		...
		List<PreparePhasingData3VO> foundEntities = entityManager.createQuery(FIND_ALL()).getResultList();
		return foundEntities;
	}

	/**
	 * Check if user has access rights to create, change and remove
	 * PreparePhasingData3 entities. If not set rollback only and throw
	 ...
	 */
	private void checkAndCompleteData(PreparePhasingData3VO vo, boolean create) throws Exception {
