...
@Remote
public interface CrystalHasUuid3Service {
	...
	/**
	 * Finds a CrystalHasUuid3 entity by its primary key and set linked value objects if necessary.
	 * 
	 * @param pk
	 *            the primary key
	 * @param withLink1
	...
	/**
	 * Find all CrystalHasUuid3 and set linked value objects if necessary.
	 * 
	 * @param withLink1
	 * @param withLink2
	 */
