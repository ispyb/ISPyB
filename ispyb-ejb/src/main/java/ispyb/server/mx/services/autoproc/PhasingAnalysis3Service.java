...
@Remote
public interface PhasingAnalysis3Service {
	...
	/**
	 * Finds a PhasingAnalysis3 entity by its primary key and set linked value objects if necessary.
	...
	/**
	 * Find all PhasingAnalysis3 and set linked value objects if necessary.
	 * @param withLink1
	 * @param withLink2
	 */
