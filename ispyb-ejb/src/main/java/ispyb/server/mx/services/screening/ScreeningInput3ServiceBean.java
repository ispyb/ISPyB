...
import ispyb.server.mx.daos.screening.ScreeningInput3DAO;
...
public class ScreeningInput3ServiceBean implements ScreeningInput3Service, ScreeningInput3ServiceLocal {
	...
	@EJB
	private ScreeningInput3DAO dao;
	...
	public ScreeningInput3VO create(final ScreeningInput3VO vo) throws Exception {
		...
		return (ScreeningInput3VO) template.execute(new EJBAccessCallback() {
	...
	public ScreeningInput3VO findByPk(final Integer pk)
		...
		return (ScreeningInput3VO) template.execute(new EJBAccessCallback() {
			...
			public Object doInEJBAccess(Object parent) throws Exception {
				checkCreateChangeRemoveAccess();
				// TODO Edit this business code
				ScreeningInput3VO found = dao.findByPk(pk);
				return found;
			}
	...
	public List<ScreeningInput3VO> findAll() throws Exception {
		EJBAccessTemplate template = new EJBAccessTemplate(LOG, context, this);
		return (List<ScreeningInput3VO>) template.execute(new EJBAccessCallback() {

			public Object doInEJBAccess(Object parent) throws Exception {
				List<ScreeningInput3VO> foundEntities = dao.findAll();
