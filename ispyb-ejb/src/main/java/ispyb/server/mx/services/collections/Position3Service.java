...
@Remote
public interface Position3Service {
	...
	/**
	 * Finds a Position3 entity by its primary key and set linked value objects if necessary.
	...
	/**
	 * Find all Position3 and set linked value objects if necessary.
	 */
