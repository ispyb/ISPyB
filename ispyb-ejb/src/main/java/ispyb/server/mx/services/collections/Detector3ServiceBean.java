 ...
 */
@Stateless
public class Detector3ServiceBean implements Detector3Service, Detector3ServiceLocal {

	private final static Logger LOG = LogManager.getLogger(Detector3ServiceBean.class);
	...
	public List<Detector3VO> findAll() throws Exception {
	...
	/**
	 * Check if user has access rights to create, change and remove Detector3
