...
@Remote
public interface PhasingStatistics3Service {
	...
	/**
	 * Finds a PhasingStatistics3 entity by its primary key and set linked value objects if necessary.
	...
	/**
	 * Find all PhasingStatistics3 and set linked value objects if necessary.
	 */
