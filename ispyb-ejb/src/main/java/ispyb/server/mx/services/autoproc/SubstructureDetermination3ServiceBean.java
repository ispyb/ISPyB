 ...
 */
@Stateless
public class SubstructureDetermination3ServiceBean
		implements SubstructureDetermination3Service, SubstructureDetermination3ServiceLocal {

	private final static Logger LOG = LogManager.getLogger(SubstructureDetermination3ServiceBean.class);
	...
	public SubstructureDetermination3VO findByPk(final Integer pk) throws Exception {
		...
		// TODO Edit this business code
		try {
			return (SubstructureDetermination3VO) entityManager.createQuery(FIND_BY_PK())
	...
	/**
	 * Find all SubstructureDetermination3s and set linked value objects if
	 * necessary
	 * 
	 * @param withLink1
	 * @param withLink2
	...
	public List<SubstructureDetermination3VO> findAll() throws Exception {
		...
		List<SubstructureDetermination3VO> foundEntities = entityManager.createQuery(FIND_ALL()).getResultList();
		return foundEntities;
	}

	/**
	 * Check if user has access rights to create, change and remove
	 * SubstructureDetermination3 entities. If not set rollback only and throw
	 ...
	 */
	private void checkAndCompleteData(SubstructureDetermination3VO vo, boolean create) throws Exception {
