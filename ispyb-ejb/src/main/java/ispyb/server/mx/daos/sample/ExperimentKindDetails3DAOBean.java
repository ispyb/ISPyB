...
/**
 * <p>
 * The data access object for ExperimentKindDetails3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link ExperimentKindDetails3DAO}
 */
@Stateless
public class ExperimentKindDetails3DAOBean implements ExperimentKindDetails3DAO {

	private final static Logger LOG = Logger.getLogger(ExperimentKindDetails3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(ExperimentKindDetails3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public ExperimentKindDetails3VO update(ExperimentKindDetails3VO vo) throws Exception {
	 ...
	 */
	public void delete(ExperimentKindDetails3VO vo) {
	...
	/**
	 * <p>
	 * Returns the ExperimentKindDetails3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public ExperimentKindDetails3VO findByPk(Integer pk, boolean fetchRelation1, boolean fetchRelation2) {
		try{
			return (ExperimentKindDetails3VO) entityManager.createQuery(FIND_BY_PK(fetchRelation1, fetchRelation2))
	...
	/**
	 * <p>
	 * Returns the ExperimentKindDetails3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<ExperimentKindDetails3VO> findAll(boolean fetchRelation1, boolean fetchRelation2) {
