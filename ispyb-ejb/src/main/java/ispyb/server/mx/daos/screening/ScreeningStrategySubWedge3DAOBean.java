...
/**
 * <p>
 * The data access object for ScreeningStrategySubWedge3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link ScreeningStrategySubWedge3DAO}
 */
@Stateless
public class ScreeningStrategySubWedge3DAOBean implements ScreeningStrategySubWedge3DAO {

	private final static Logger LOG = Logger.getLogger(ScreeningStrategySubWedge3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(ScreeningStrategySubWedge3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public ScreeningStrategySubWedge3VO update(ScreeningStrategySubWedge3VO vo) throws Exception {
	 ...
	 */
	public void delete(ScreeningStrategySubWedge3VO vo) {
	...
	/**
	 * <p>
	 * Returns the ScreeningStrategySubWedge3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public ScreeningStrategySubWedge3VO findByPk(Integer pk) {
		try{
	...
	/**
	 * <p>
	 * Returns the ScreeningStrategySubWedge3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
