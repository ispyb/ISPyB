...
/**
 * <p>
 * 	The data access object for ExperimentKindDetails3 objects (rows of table
 *  ExperimentKindDetails).
 * </p>
 */
@Local
public interface ExperimentKindDetails3DAO {
	 ...
	 */
	public ExperimentKindDetails3VO findByPk(Integer pk, boolean fetchRelation1,
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<ExperimentKindDetails3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
