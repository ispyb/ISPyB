...
/**
 * <p>
 * 	The data access object for Detector3 objects (rows of table
 *  Detector).
 * </p>
 */
@Local
public interface Detector3DAO {
	 ...
	 * @return
	 */
	public List<Detector3VO> findFiltered(String detectorType, String detectorManufacturer, 
			String detectorModel, Double detectorPixelSizeHorizontal, 
			Double detectorPixelSizeVertical, String detectorMode);
