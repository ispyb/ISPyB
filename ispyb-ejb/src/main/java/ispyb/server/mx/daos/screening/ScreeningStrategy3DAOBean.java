...
/**
 * <p>
 * The data access object for ScreeningStrategy3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link ScreeningStrategy3DAO}
 */
@Stateless
public class ScreeningStrategy3DAOBean implements ScreeningStrategy3DAO {

	private final static Logger LOG = Logger.getLogger(ScreeningStrategy3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(ScreeningStrategy3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public ScreeningStrategy3VO update(ScreeningStrategy3VO vo) throws Exception {
	 ...
	 */
	public void delete(ScreeningStrategy3VO vo) {
	...
	/**
	 * <p>
	 * Returns the ScreeningStrategy3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public ScreeningStrategy3VO findByPk(Integer pk, boolean fetchScreeningStrategyWedge) {
		try{
			return (ScreeningStrategy3VO) entityManager.createQuery(FIND_BY_PK(fetchScreeningStrategyWedge))
	...
	/**
	 * <p>
	 * Returns the ScreeningStrategy3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<ScreeningStrategy3VO> findAll(boolean fetchScreeningStrategyWedge) {
		return entityManager.createQuery(FIND_ALL(fetchScreeningStrategyWedge)).getResultList();
	}
