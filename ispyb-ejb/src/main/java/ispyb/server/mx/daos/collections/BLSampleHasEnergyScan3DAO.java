...
/**
 * <p>
 * 	The data access object for BLSampleHasEnergyScan3 objects (rows of table
 *  BLSample_has_EnergyScan).
 * </p>
 */
@Local
public interface BLSampleHasEnergyScan3DAO {
	 ...
	 */
	public BLSampleHasEnergyScan3VO findByPk(Integer pk, boolean fetchRelation1,
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<BLSampleHasEnergyScan3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
