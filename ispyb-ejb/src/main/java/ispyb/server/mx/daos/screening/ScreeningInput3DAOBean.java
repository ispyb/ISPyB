...
/**
 * <p>
 * The data access object for ScreeningInput3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link ScreeningInput3DAO}
 */
@Stateless
public class ScreeningInput3DAOBean implements ScreeningInput3DAO {

	private final static Logger LOG = Logger.getLogger(ScreeningInput3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(ScreeningInput3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public ScreeningInput3VO update(ScreeningInput3VO vo) throws Exception {
	 ...
	 */
	public void delete(ScreeningInput3VO vo) {
	...
	/**
	 * <p>
	 * Returns the ScreeningInput3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public ScreeningInput3VO findByPk(Integer pk) {
		try{
	...
	/**
	 * <p>
	 * Returns the ScreeningInput3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<ScreeningInput3VO> findAll() {
