...
/**
 * <p>
 * The data access object for IspybCrystalClass3 objects (rows of table IspybCrystalClass).
 * </p>
 * 
 * @see {@link IspybCrystalClass3DAO}
 */
@Stateless
public class IspybCrystalClass3DAOBean implements IspybCrystalClass3DAO {

	private final static Logger LOG = Logger.getLogger(IspybCrystalClass3DAOBean.class);
