 ...
 *  AutoProcStatus).
 * </p>
 * @see {@link AutoProcStatus3DAO}
 */
@Stateless
public class AutoProcStatus3DAOBean implements AutoProcStatus3DAO {

	private final static Logger LOG = Logger.getLogger(AutoProcStatus3DAOBean.class);
	...
	public List<AutoProcStatus3VO> findAll() {
		return (List<AutoProcStatus3VO>) entityManager.createQuery(
