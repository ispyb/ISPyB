...
/**
 * <p>
 * 	The data access object for XmlDocument3 objects (rows of table
 *  XmlDocument).
 * </p>
 */
@Local
public interface XmlDocument3DAO {
	 ...
	 */
	public XmlDocument3VO findByPk(Integer pk, boolean fetchRelation1,
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<XmlDocument3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
