...
/**
 * <p>
 * The data access object for ScreeningRank3 objects (rows of table ScreeningRank).
 * </p>
 * 
 * @see {@link ScreeningRank3DAO}
 */
@Stateless
public class ScreeningRank3DAOBean implements ScreeningRank3DAO {

	private final static Logger LOG = Logger.getLogger(ScreeningRank3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(ScreeningRank3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public ScreeningRank3VO update(ScreeningRank3VO vo) throws Exception {
	 ...
	 */
	public void delete(ScreeningRank3VO vo) {
	...
	/**
	 * <p>
	 * Returns the ScreeningRank3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public ScreeningRank3VO findByPk(Integer pk) {
		try{
	...
	/**
	 * <p>
	 * Returns the ScreeningRank3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<ScreeningRank3VO> findAll() {
