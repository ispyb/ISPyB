...
/**
 * <p>
 * 	The data access object for DiffractionPlan3 objects (rows of table
 *  DiffractionPlan).
 * </p>
 */
@Local
public interface DiffractionPlan3DAO {
	 ...
	 */
	public DiffractionPlan3VO findByPk(Integer pk, boolean fetchRelation1,
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<DiffractionPlan3VO> findAll(boolean fetchRelation1,
			boolean fetchRelation2);
