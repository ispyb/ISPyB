...
/**
 * <p>
 * The data access object for AutoProcScaling3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link AutoProcScaling3DAO}
 */
@Stateless
public class AutoProcScaling3DAOBean implements AutoProcScaling3DAO {

	private final static Logger LOG = Logger.getLogger(AutoProcScaling3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(AutoProcScaling3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public AutoProcScaling3VO update(AutoProcScaling3VO vo) throws Exception {
	 ...
	 */
	public void delete(AutoProcScaling3VO vo) {
	...
	/**
	 * <p>
	 * Returns the AutoProcScaling3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public AutoProcScaling3VO findByPk(Integer pk) {
		try{
	...
	/**
	 * <p>
	 * Returns the AutoProcScaling3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
