...
/**
 * <p>
 * 	The data access object for Position3 objects (rows of table
 *  Position).
 * </p>
 * @see {@link Position3DAO}
 */
@Stateless
public class Position3DAOBean implements Position3DAO {

	private final static Logger LOG = Logger.getLogger(Position3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(Position3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public Position3VO update(Position3VO vo) throws Exception {
	 ...
	 */
	public void delete(Position3VO vo) {
	...
	/**
	 * <p>
	 * 	Returns the Position3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public Position3VO findByPk(Integer pk) {
		try {
	...
	/**
	 * <p>
	 * 	Returns the Position3VO instances.
	 * </p>
	 * <p>
	 *  <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u>
	 *  if the value object has to be used out the EJB container.
	...
	public List<Position3VO> findAll() {
		return (List<Position3VO>) entityManager.createQuery(
