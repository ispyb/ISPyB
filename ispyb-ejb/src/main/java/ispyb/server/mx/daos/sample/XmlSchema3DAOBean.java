...
/**
 * <p>
 * The data access object for XmlSchema3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link XmlSchema3DAO}
 */
@Stateless
public class XmlSchema3DAOBean implements XmlSchema3DAO {

	private final static Logger LOG = Logger.getLogger(XmlSchema3DAOBean.class);

	// Generic HQL request to find instances of XmlSchema3 by pk
	// TODO choose between left/inner join
	private static final String FIND_BY_PK(boolean fetchLink1, boolean fetchLink2) {
		return "from XmlSchema3VO vo " + (fetchLink1 ? "<inner|left> join fetch vo.link1 " : "")
				+ (fetchLink2 ? "<inner|left> join fetch vo.link2 " : "") + "where vo.xmlSchemaId = :pk";
	}

	// Generic HQL request to find all instances of XmlSchema3
	// TODO choose between left/inner join
	 ...
	 */
	public XmlSchema3VO findByPk(Integer pk, boolean fetchRelation1, boolean fetchRelation2) {
		try{
			return (XmlSchema3VO) entityManager.createQuery(FIND_BY_PK(fetchRelation1, fetchRelation2))
	...
	public List<XmlSchema3VO> findAll(boolean fetchRelation1, boolean fetchRelation2) {
	 ...
	 */
	private void checkAndCompleteData(XmlSchema3VO vo, boolean create) throws Exception {
