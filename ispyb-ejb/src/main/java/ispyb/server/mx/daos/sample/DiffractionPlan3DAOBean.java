...
/**
 * <p>
 * The data access object for DiffractionPlan3 objects (rows of table TableName).
 * </p>
 * 
 * @see {@link DiffractionPlan3DAO}
 */
@Stateless
public class DiffractionPlan3DAOBean implements DiffractionPlan3DAO {

	private final static Logger LOG = Logger.getLogger(DiffractionPlan3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(DiffractionPlan3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public DiffractionPlan3VO update(DiffractionPlan3VO vo) throws Exception {
	 ...
	 */
	public void delete(DiffractionPlan3VO vo) {
	...
	/**
	 * <p>
	 * Returns the DiffractionPlan3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public DiffractionPlan3VO findByPk(Integer pk, boolean fetchRelation1, boolean fetchRelation2) {
		try{
		return (DiffractionPlan3VO) entityManager.createQuery(FIND_BY_PK(fetchRelation1, fetchRelation2))
	...
	/**
	 * <p>
	 * Returns the DiffractionPlan3VO instances.
	 * </p>
	 * <p>
	 * <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u> if the value object has to be
	 * used out the EJB container.
	...
	public List<DiffractionPlan3VO> findAll(boolean fetchRelation1, boolean fetchRelation2) {
