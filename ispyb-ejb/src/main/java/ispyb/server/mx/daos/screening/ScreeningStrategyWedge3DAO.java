...
/**
 * <p>
 * 	The data access object for ScreeningStrategyWedge3 objects (rows of table
 *  ScreeningStrategyWedge).
 * </p>
 */
@Local
public interface ScreeningStrategyWedge3DAO {
	 ...
	 */
	public ScreeningStrategyWedge3VO findByPk(Integer pk, boolean fetchScreeningStrategySubWedge1);
	 ...
	 * @param fetchRelation2 if true, the linked instances by the relation "relation2" will be set.
	 */
	public List<ScreeningStrategyWedge3VO> findAll(boolean fetchScreeningStrategySubWedge1);
