...
/**
 * <p>
 * 	The data access object for PhasingStatistics3 objects (rows of table
 *  PhasingStatistics).
 * </p>
 * @see {@link PhasingStatistics3DAO}
 */
@Stateless
public class PhasingStatistics3DAOBean implements PhasingStatistics3DAO {

	private final static Logger LOG = Logger.getLogger(PhasingStatistics3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(PhasingStatistics3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public PhasingStatistics3VO update(PhasingStatistics3VO vo) throws Exception {
	 ...
	 */
	public void delete(PhasingStatistics3VO vo) {
	...
	/**
	 * <p>
	 * 	Returns the PhasingStatistics3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public PhasingStatistics3VO findByPk(Integer pk) {
		try {
	...
	/**
	 * <p>
	 * 	Returns the PhasingStatistics3VO instances.
	 * </p>
	 * <p>
	 *  <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u>
	 *  if the value object has to be used out the EJB container.
	...
	public List<PhasingStatistics3VO> findAll() {
		return (List<PhasingStatistics3VO>) entityManager.createQuery(
