...
/**
 * <p>
 * 	The data access object for PhasingProgramAttachment3 objects (rows of table
 *  PhasingProgramAttachment).
 * </p>
 * @see {@link PhasingProgramAttachment3DAO}
 */
@Stateless
public class PhasingProgramAttachment3DAOBean implements PhasingProgramAttachment3DAO {

	private final static Logger LOG = Logger.getLogger(PhasingProgramAttachment3DAOBean.class);
	 ...
	 * </p>
	 */
	public void create(PhasingProgramAttachment3VO vo) throws Exception {
	 ...
	 * </p>
	 */
	public PhasingProgramAttachment3VO update(PhasingProgramAttachment3VO vo) throws Exception {
	 ...
	 */
	public void delete(PhasingProgramAttachment3VO vo) {
	...
	/**
	 * <p>
	 * 	Returns the PhasingProgramAttachment3VO instance matching the given primary key.
	 * </p>
	 * <p>
	 ...
	 */
	public PhasingProgramAttachment3VO findByPk(Integer pk) {
		try {
	...
	/**
	 * <p>
	 * 	Returns the PhasingProgramAttachment3VO instances.
	 * </p>
	 * <p>
	 *  <u>Please note</u> that the booleans to fetch relationships are needed <u>ONLY</u>
	 *  if the value object has to be used out the EJB container.
	...
	public List<PhasingProgramAttachment3VO> findAll() {
		return (List<PhasingProgramAttachment3VO>) entityManager.createQuery(
	...
	@SuppressWarnings("unchecked")
	public List<PhasingProgramAttachment3VO> findFiltered(Integer phasingProgramRunId) {
