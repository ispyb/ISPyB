...
public class DiffractionPlanWS3VO extends DiffractionPlan3VO {
	...
	public DiffractionPlanWS3VO(Integer diffractionPlanId, Integer xmlDocumentId2, String experimentKind,
			...
			Double radiationSensitivityGamma) {
		super(diffractionPlanId, null, experimentKind,
				...
				anomalousScatterer, preferredBeamSizeX, preferredBeamSizeY, comments,
				...
				minDimAccrossSpindleAxis, maxDimAccrossSpindleAxis, radiationSensitivityBeta, radiationSensitivityGamma);
