...
public class PhasingWS3VO extends Phasing3VO{
	...
	public PhasingWS3VO(Integer phasingAnalysisId, Integer phasingProgramRunId, Integer spaceGroupId) {
		super();
	...
	public PhasingWS3VO(Integer phasingId,
			Integer phasingAnalysisId,
			Integer phasingProgramRunId,
			Integer spaceGroupId, String method, Double solventContent,
			Boolean enantiomorph, Double lowRes, Double highRes, Date recordTimeStamp) {
		super();
