...
public class PreparePhasingDataWS3VO extends PreparePhasingData3VO{
	...
	public PreparePhasingDataWS3VO() {
		super();
	}

	
	public PreparePhasingDataWS3VO(Integer phasingAnalysisId, Integer phasingProgramRunId, Integer spaceGroupId) {
		super();
	...
	public PreparePhasingDataWS3VO(Integer preparePhasingDataId,
