...
public class ModelBuildingWS3VO extends ModelBuilding3VO{
	...
	public ModelBuildingWS3VO() {
		super();
	}

	
	public ModelBuildingWS3VO(Integer phasingAnalysisId, Integer phasingProgramRunId, Integer spaceGroupId) {
		super();
	...
	public ModelBuildingWS3VO(Integer modelBuildingId,
			Integer phasingAnalysisId,
			Integer phasingProgramRunId,
			Integer spaceGroupId, Double lowRes, Double highRes, Date recordTimeStamp) {
		super();
