...
LEFT JOIN BLSample ON DataCollectionGroup.blSampleId = BLSample.blSampleId
LEFT JOIN Crystal ON Crystal.crystalId = BLSample.crystalId where Crystal.proteinId = Protein.proteinId)) as DataCollectionIdList,
