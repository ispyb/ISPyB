insert into SchemaStatus (scriptName, schemaStatus) values ('2017_01_17_Change_biosaxs_view.sql','ONGOING');
USE `pydb`;
CREATE 
...
VIEW `v_saxs_datacollection` AS
    SELECT 
        ...
        `SubtractionToAbInitioModel`.`abinitioId` AS `SubtractionToAbInitioModel_abinitioId`
    FROM
        (((((((((((`Measurement`
        ...
        -- last line of script  
update SchemaStatus set schemaStatus = 'DONE' where scriptName = '2017_01_17_Change_biosaxs_view.sql'; 
