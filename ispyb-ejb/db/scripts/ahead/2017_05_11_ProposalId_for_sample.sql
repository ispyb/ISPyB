use `pydb`;
insert into SchemaStatus (scriptName, schemaStatus) values ('2017_05_11_ProposalId_for_sample.sql','ONGOING');
...
update SchemaStatus set schemaStatus = 'DONE' where scriptName = '2017_05_11_ProposalId_for_sample.sql';