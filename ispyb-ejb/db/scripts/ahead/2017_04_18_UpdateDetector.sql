insert into SchemaStatus (scriptName, schemaStatus) values ('2017_04_18_UpdateDetector.sql','ONGOING');
...
update SchemaStatus set schemaStatus = 'DONE' where scriptName = '2017_04_18_UpdateDetector.sql';
