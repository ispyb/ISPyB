...
insert into SchemaStatus (scriptName, schemaStatus) values ('2017_05_04_BeamlineName.sql','ONGOING');
...
VIEW `pydb`.`v_datacollection_summary` AS
    ...
    FROM
        ...
        update SchemaStatus set schemaStatus = 'DONE' where scriptName = '2017_05_04_BeamlineName.sql';
