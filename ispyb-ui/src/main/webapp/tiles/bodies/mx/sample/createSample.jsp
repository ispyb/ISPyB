						...
						<%-- Diffraction Plan --%>
							<layout:grid cols="2" styleClass="SEARCH_GRID">	
								<layout:column>
									...
									<layout:text key="Preferred Beam Size X (mm)" 	property="difPlanInfo.preferredBeamSizeX" 	styleClass="FIELD"	mode="E,E,E" />
									<layout:text key="Preferred Beam Size Y (mm)" 	property="difPlanInfo.preferredBeamSizeY" 	styleClass="FIELD"	mode="E,E,E" />
