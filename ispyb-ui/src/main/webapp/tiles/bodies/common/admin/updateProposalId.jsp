...
<h3> Update of proposalId for all sessions</h3>

<layout:row>

<layout:panel key="Date for update" align="left" styleClass="PANEL">
<layout:form action="/manager/updateProposalId.do" reqCode="update">
	
	<layout:grid cols="1" styleClass="SEARCH_GRID">	
		<layout:column>
					<layout:text key="new proposalId" 	property="newPropId" 	styleClass="FIELD" 	mode="E,E,E"/>
					<layout:text key="old proposalId" 	property="oldPropId" 	styleClass="FIELD" 	mode="E,E,E"/>
		</layout:column>		
