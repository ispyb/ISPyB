...
<CENTER><H2><layout:write name="adminSiteForm" property="chartTitle"/></H2></CENTER>
...
if (AC_FL_RunContent == 0 || DetectFlashVer == 0) {
	...
	if(hasRightVersion) {  // if we've detected an acceptable version
		...
		AC_FL_RunContent(
			...
			'FlashVars', 'library_path=<%=request.getContextPath()%>/config/flashcharts/charts_library&xml_source=<layout:write name="adminSiteForm" property="reportDataUrl"/>', 
			'wmode', 'opaque',
			'scale', 'noScale',
			'id', 'charts',
			'name', 'charts',
