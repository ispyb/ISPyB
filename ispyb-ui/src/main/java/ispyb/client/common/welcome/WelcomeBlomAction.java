...
/**
 * 
 * @struts.action path="/blom/welcomeBlom"
 *                
 * 
 * @struts.action-forward name="error" path="site.default.error.page"
 * 
 * @struts.action-forward name="success" path="blom.welcome.page"
 * 
 */
public class WelcomeBlomAction extends Action {
	private final Logger LOG = Logger.getLogger(WelcomeBlomAction.class);
	
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            HttpServletRequest request, HttpServletResponse response) {

        LOG.debug("Welcome Blom Page");
        ...
        // Set proposalId to null since Blom should not have a specific proposal
        String proposalCode = Constants.PROPOSAL_CODE_ALL;
		String proposalNumber = Constants.PROPOSAL_NUMBER_BLOM;
