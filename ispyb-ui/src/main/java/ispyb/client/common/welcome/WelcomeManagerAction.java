...
/**
 * 
 * @struts.action path="/manager/welcomeManager"
 * 
 * 
 * @struts.action-forward name="error" path="site.default.error.page"
 * 
 * @struts.action-forward name="success" path="manager.welcome.page"
 * 
 */
public class WelcomeManagerAction extends Action {
	private final Logger LOG = Logger.getLogger(WelcomeManagerAction.class);
	
	@Override
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
			HttpServletResponse response) {

		LOG.debug("retrieve all proposals");
