...
/**
 * @struts.action name="viewShippingForm" path="/user/viewStorageDewarAction"
 *                type="ispyb.client.common.shipping.ViewStorageDewarAction" validate="false" parameter="reqCode"
 *                scope="request"
 * 
 * @struts.action-forward name="storageDewarViewPage" path="user.storageDewar.view.page"
 * 
...
public class ViewStorageDewarAction extends ViewShippingAction {
	private final Logger LOG = Logger.getLogger(ViewStorageDewarAction.class);
...
//	@Override
	public ActionForward display(ActionMapping mapping, ActionForm actForm, HttpServletRequest request, HttpServletResponse in_reponse) {
		...
		return mapping.findForward("storageDewarViewPage");
	}
