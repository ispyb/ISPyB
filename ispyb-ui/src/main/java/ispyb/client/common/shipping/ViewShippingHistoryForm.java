...
/**
 * @struts.form name="viewShippingHistoryForm"
 */

public class ViewShippingHistoryForm extends ActionForm implements Serializable {
	...
	private Collection<Dewar3VO> dewars = new ArrayList<Dewar3VO>();

	// ______________________________________________________________________________________________________________________

	public ViewShippingHistoryForm() {
	}
	...
	public Collection<Dewar3VO> getDewars() {
		return dewars;
	}

	public void setDewars(Collection<Dewar3VO> dewars) {
		this.dewars = dewars;
	}

	// public Collection<DewarTransportHistoryLightValue> getDewarEvents() {
	// return dewarEvents;
	// }
	//
	// public void setDewarEvents(
	// Collection<DewarTransportHistoryLightValue> dewarEvents) {
