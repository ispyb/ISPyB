...
public class LoginModule {
		static String groupUniqueMemberName = "uniqueMember";
		static String principalDNSuffix = ",ou=People,dc=esrf,dc=fr";
		static String groupCtxDN = "ou=Pxwebgroups,dc=esrf,dc=fr";
		static String principalDNPrefix = "uid=";
		static String groupAttributeID = "cn";
		static String server = "ldap://ldap.esrf.fr:389/";
