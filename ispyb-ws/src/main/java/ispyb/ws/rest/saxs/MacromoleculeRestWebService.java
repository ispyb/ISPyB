...
public class MacromoleculeRestWebService extends RestWebService {
	...
	public Response getMacromoleculeList(@PathParam("cookie") String cookie, @PathParam("proposal") String proposal)
			throws Exception {
	...
	@Produces({ "application/json" })
	public Response saveMacromolecule(@PathParam("cookie") String cookie, @PathParam("proposal") String proposal,
			@FormParam("macromolecule") String macromolecule) throws Exception {

		String methodName = "saveMacromolecule";
		long id = this.logInit(methodName, logger, cookie, proposal, macromolecule);
		try {
