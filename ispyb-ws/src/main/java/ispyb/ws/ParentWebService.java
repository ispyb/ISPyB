...
import ispyb.server.common.services.shipping.ContainerHistory3Service;
...
public  class ParentWebService {
	...
	protected ContainerHistory3Service getContainerHistory3Service() throws NamingException {
		return (ContainerHistory3Service) Ejb3ServiceLocator.getInstance().getLocalService(ContainerHistory3Service.class);
	}
